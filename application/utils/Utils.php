...
class Utils {
    ...
    public function drawPager($totalItems, $perPage) {
        ...
        $pager .= "<li><a href='/admin/products?page=1' aria-label='Previous'><span aria-hidden='true'>&laquo;</span> Начало</a></li>";
        for($i=2; $i<=$pages-1; $i++) {
            $pager .= "<li><a href='/admin/products?page=". $i."'>" . $i ."</a></li>";
        }
        $pager .= "<li><a href='/admin/products?page=". $pages ."' aria-label='Next'>Конец <span aria-hidden='true'>&raquo;</span></a></li>";
        $pager .= "</ul>";
